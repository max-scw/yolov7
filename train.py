...
def train(hyp: Dict[str, float], opt, device):
    ...
    dataloader, dataset = create_dataloader(
        ...
        global_augmentation_probability=opt.augmentation_probability if opt.augmentation_probability else (hyp["ablumentation_p"] if "ablumentation_p" in hyp else None),
